...
class KapTazeAdminDashboard {
    ...
    async loadDataFromMongoDB() {
        try {
            console.log('📡 Loading from MongoDB Atlas...');
            
            // Get statistics from MongoDB
            const stats = await window.KapTazeMongoDB.getStatistics();
            
            // Get applications
            this.data.applications = await window.KapTazeMongoDB.getApplications();
            
            // Get packages
            this.data.packages = await window.KapTazeMongoDB.getPackages();
            
            // Get restaurants
            this.data.restaurants = await window.KapTazeMongoDB.getRestaurants();
            ...
            console.warn('⚠️ MongoDB failed, using localStorage:', error);
            await this.loadDataFromLocalStorage();
        }
    }
