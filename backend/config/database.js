...
const DatabaseConfig = {
    ...
    default: {
        uri: process.env.MONGODB_URI || 'mongodb+srv://kaptaze-admin:21651121@kaptaze-cluster.ra9padd.mongodb.net/kaptazeappv5?retryWrites=true&w=majority',
        options: {
    ...
    development: {
        uri: process.env.MONGODB_URI || 'mongodb+srv://kaptaze-admin:21651121@kaptaze-cluster.ra9padd.mongodb.net/kaptaze_dev?retryWrites=true&w=majority',
        options: {
            useNewUrlParser: true,
            useUnifiedTopology: true,
            maxPoolSize: 5,
    ...
    test: {
        uri: process.env.MONGODB_TEST_URI || 'mongodb+srv://kaptaze-admin:21651121@kaptaze-cluster.ra9padd.mongodb.net/kaptaze_test?retryWrites=true&w=majority',
        options: {
            useNewUrlParser: true,
            useUnifiedTopology: true,
            maxPoolSize: 5,
