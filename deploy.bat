...
if %ERRORLEVEL% neq 0 (
    ...
    echo 🌐 URL: https://https://kaptaze.com/
)
cd ..\..
echo.
...
echo.
echo 📊 Sonuçlar:
echo ✅ Ana Portal: https://https://kaptaze.com/
...
echo    CORS_ORIGIN=https://https://kaptaze.com/
echo.
